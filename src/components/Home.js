      ...
      <div className='col-6'>
          <div className="card bg-secondary" style={accBox}>
            <div className="card-body">
              ...
              <p className="card-text display-6" style={smaller}>${formattedBalance}</p>
            </div>
          </div>
      </div>
      <div className='col-6'>
          <div className="card bg-secondary" style={accBox}>
            <div className="card-body">
              ...
              <p className="card-text display-6" style={smaller}>${formattedDailyDropsBalance}</p>
            </div>
          </div>
      </div>
    </div>
      ...
      <div className='col-6'>
          <div className="card bg-secondary" style={accBox}>
            <div className="card-body">
              ...
              <p className="card-text display-6" style={smaller}>$0</p>
            </div>
          </div>
      </div>
      <div className='col-6'>
          <div className="card bg-secondary" style={accBox}>
            <div className="card-body">
              ...
              <p className="card-text display-6" style={smaller}>${formattedDeposit}</p>
            </div>
          </div>
      </div>
    </div>
      ...
      <div className='col-6'>
          <div className="card bg-secondary" style={accBox}>
            <div className="card-body">
              ...
              <p className="card-text display-6" style={smaller}>${formattedReferralBalance}</p>
            </div>
          </div>
      </div>
    </div>
